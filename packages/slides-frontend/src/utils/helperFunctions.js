...
const getBarsWidth = () =>
  document.getElementById('sidebar').offsetWidth + document.getElementById('settings').offsetWidth;
...
export {canDeleteImageFromBackend, deepCopyFunction, getPercentage, getPixels, getWidth};
